...
class Spider(Spider):
    def init(self, extend='{}'):
        ...
        self.playRc4Key = '69328e6da802c3a866fdbb742b477336'#播放key自己抓包
        self.fixedTime = '1780698822'##分类page
        self.fixedKey = 'f07e2ea9b85a4e45e334'##分类page
        ...
        self.detailTime = '1780698828'##详情页ids
        self.detailKey = '1756a513ee6845b27786'##详情页ids
        self.categoryTime = self.fixedTime
        self.categoryKey = self.fixedKey
        self.fixedEdition = '5.8'##Client抓播放
        self.app = '10147'##Client抓播放
