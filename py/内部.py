...
#熊修，可py内部填写,也可以和潇洒appget一样ext下面填写，外部填写会覆盖py内部填写
...
class Spider(Spider):
    ...
    def init(self, extend=''):
        self.site_url = "http://qfys.myqf.asia/getapp.txt"
        self.dataKey = "vpsj6z4e7scbjbis"
        self.dataIv = "vpsj6z4e7scbjbis"
        self.token = "a4b9ec2a575629bcc70a8b22b20ec0701747b20e71a9659f8c33fd5a162748f0"
        self.device_id = "cfcfe4cf-61a3-431e-a08b-11a36758700e"
        self.version = "1.0.0"
