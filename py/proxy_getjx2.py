...
# nox解析本地预设参数示例
# proxy://do=py&siteKey=proxy_noxjx&type=nox_jx&source=追片喵&url=视频链接

# app_configs示例
app_configs = {
    "追片喵": {
        "host": "https://2svip.2video.cc",
        "userld": "xxxx",
        "verCode": "56",
        "verName": "1.2.6",
        "deviceld": "7085004fe80a61",
        "package": "com.ds.wlss",
...
# 使用示例：
# 1. 在应用中配置app_configs
# 2. 构造代理链接：proxy://do=py&siteKey=proxy_noxjx&type=nox_jx&source=追片喵&url=https://v.qq.com/x/cover/xxxxx.html
# 3. 系统会根据source字段（追片喵）从app_configs读取host等参数
# 4. 向host地址发送解析请求获取视频播放地址
